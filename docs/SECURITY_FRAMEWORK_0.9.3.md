...
ORIEL 0.9.3 supplies dependency-free security building blocks for its API and web frameworks.
...
The framework also provides thread-safe expiring sessions and revocation, session-bound CSRF tokens, permission enforcement, fixed-window rate limiting, and web middleware for CSP, referrer, permissions, framing, and MIME-sniffing policies.
